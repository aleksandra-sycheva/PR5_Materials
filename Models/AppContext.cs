...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<HistoryOfProduct>(entity =>
        {
            ...
            entity.HasOne(d => d.IdPartnerNavigation).WithMany(p => p.HistoryOfProducts)
                .HasForeignKey(d => d.IdPartner)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("Partners_Products_IdPartner_fkey");

            entity.HasOne(d => d.IdProductNavigation).WithMany(p => p.HistoryOfProducts)
        ...
        modelBuilder.Entity<Supplier>(entity =>
        {
            ...
            entity.Property(e => e.AvgQualityOfSuppliers).HasColumnName("avg_quality_of_suppliers");
